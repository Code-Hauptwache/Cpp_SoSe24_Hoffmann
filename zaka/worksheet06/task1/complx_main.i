...
namespace ToComplx{
  class Complx {
    private:
      ...
      double im;
    public:
      explicit Complx(double r, double i) : re{r}, im{i} { };
      Complx(double r) : re{r}, im{0.0} { };
      explicit Complx() : re{0.0}, im{0.0} { };
      ~Complx() {std::cout << "Objekt Zerstoert" << std::endl ;};

      Complx(const Complx& z) : re(z.re), im(z.im) { };
